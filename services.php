...
<body>
    ...
    <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
      ...
      <div id="mega-menu" class="hidden justify-between items-center w-full text-sm md:flex md:w-auto md:order-1">
        <ul class="flex flex-col mt-4 font-semibold md:flex-row md:space-x-8 md:mt-0">
          ...
          <li>
            <a href="services.php" class="block py-2 pr-4 pl-3 text-orange-400 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-orange-400 md:p-0 dark:text-blue-500 md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-blue-500 md:dark:hover:bg-transparent dark:border-gray-700" aria-current="page">Services</a>
          </li>
          <li>
    ...
    <div class="">
      <div class="">
        <div class="flex flex-wrap  w-full bg-gray-100 py-32 px-10 relative ">
          <img alt="gallery" class="w-full object-cover h-full object-center block opacity-100 absolute inset-0" src="breadcrumb-bg.jpg.webp">
          <div class="text-center relative z-10 w-full">
            <h1 class="text-6xl text-gray-300 text-white font-bold title-font mb-2">SERVICES
            </h1>

            <a href="index.html" class="text-white font-medium">Home ></a> <span class="text-orange-500 font-medium">Services</span>
  ...
  <section class="text-gray-600 bg-zinc-900 body-font">
    <div class="container px-5 py-24 mx-auto">
      <div class="flex flex-col text-center w-full mb-20">
        <p class="lg:w-2/2  w-full leading-relaxed text-orange-500 text-xxl font-medium">WHAT WE DO?
        </p>
        <h1 class="text-3xl font-bold font-medium title-font mb-4 text-white tracking-widest">PUSH YOUR LIMITS FORWARD</h1>
      </div>
      <div class="flex flex-wrap -m-4">
        <div class="p-4 lg:w-1/2">
          <div class="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
            <img alt="team" class="flex-shrink-0 rounded-lg w-48 h-48 object-cover object-center sm:mb-0 mb-4" src="https://source.unsplash.com/200x200/?Personal training">
            <div class="flex-grow bg-black rounded-lg p-8 sm:pl-8">
              <h1 class="title-font font-medium text-lg  text-white">Personal training</h1>

              <p class="mb-4 text-sm text-gray-400">Lorem ipsum dolor sit amet consectetur adipisicing elit. Vel,
                consequuntur consectetur!
                Fuga quidem iste numquam omnis ducimus nulla. Culpa eos non sed beatae in quo vitae, vel eius et neque?
              </p>
              <a href="#" class="text-white hover:text-orange-400">Explore</a>
        ...
        <div class="p-4 lg:w-1/2">
          <div class="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
            <img alt="team" class="flex-shrink-0 rounded-lg w-48 h-48 object-cover object-center sm:mb-0 mb-4" src="https://source.unsplash.com/200x200/?Group fitness classes">
            <div class="flex-grow bg-black rounded-lg p-8 sm:pl-8">
              <h1 class="title-font font-medium text-lg  text-white">Group fitness classes</h1>

              <p class="mb-4 text-sm text-gray-400">Quis ipsum suspendisse ultrices gravida. Risus commodo viverra
        ...
        <div class="p-4 lg:w-1/2">
          <div class="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
            <img alt="team" class="flex-shrink-0 rounded-lg w-48 h-48 object-cover object-center sm:mb-0 mb-4" src="https://source.unsplash.com/200x200/?Strength training">
            <div class="flex-grow bg-black rounded-lg p-8 sm:pl-8">
              <h1 class="title-font font-medium text-lg  text-white">Strength training</h1>
        ...
        <div class="p-4 lg:w-1/2">
          <div class="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
            <img alt="team" class="flex-shrink-0 rounded-lg w-48 h-48 object-cover object-center sm:mb-0 mb-4" src="https://source.unsplash.com/200x200/?Body building">
            <div class="flex-grow bg-black rounded-lg p-8 sm:pl-8">
              <h1 class="title-font font-medium text-lg  text-white">Body building</h1>

              <p class="mb-4 text-sm text-gray-400">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
      ...
      <div class="">
        <div class="flex flex-wrap  w-full bg-gray-100 py-32 px-10 relative ">
          ...
          <div class="text-center relative z-10 w-full">
            ...
            <button class="mt-3 p-3 px-5 text-white inline-flex mt-10 items-center border-2 border-orange-500"><a href="appointment.php">APPOINTMENT</a> </button>
            <!-- <a class="mt-3 text-indigo-500 inline-flex items-center">Learn More -->
    ...
    <div class="container px-5 py-24 mx-auto">
      <div class="flex flex-col text-center w-full mb-20">
        ...
        <div class="flex mx-auto border-2 border-orange-500 rounded overflow-hidden mt-6">
          ...
          <button class="py-1 px-4 text-gray-200 focus:outline-none"><a href="annually.php">Annually</a> </button>
        </div>
      </div>
      <div class="flex flex-wrap -m-4">
        <div class="p-4 xl:w-1/4 md:w-1/2 w-full">
          <div class="h-full p-6 rounded-lg border-2 border-gray-300 flex flex-col relative overflow-hidden">
            ...
            <button class="flex items-center mt-auto  text-white bg-gray-400 border-0 py-2 px-4 w-full focus:outline-none hover:bg-gray-500 rounded"><a href="login.php">ENROLL NOW</a>
        ...
        <div class="p-4 xl:w-1/4 md:w-1/2 w-full">
          <div class="h-full p-6  rounded-lg border-2 border-orange-500 flex flex-col relative overflow-hidden">
            ...
            <button class="flex items-center mt-auto text-white bg-orange-500 border-0 py-2 px-4 w-full focus:outline-none hover:bg-orange-600 rounded"><a href="login.php">ENROLL NOW</a>
              <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-4 h-4 ml-auto" viewBox="0 0 24 24">
                <path d="M5 12h14M12 5l7 7-7 7"></path>
              </svg>
            </button>
  ...
  <footer class="text-white  bg-black body-font">
    <div class="container px-10  mx-auto py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
