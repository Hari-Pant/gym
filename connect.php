<?php
    ...
    // $conn = new newsqli('localhost', 'root', '', 'gym');
    // if($conn->connect_error){
    //     die('Connection Failed: ' .$conn->connect_error);

    // }
    // else{
    //     $stmt = $conn->prepare("insert into registration(username, email, password, confirmPassword) value($username, $email, $password, $confirmPassword)")
