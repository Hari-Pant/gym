  ...
  <!-- <header class="text-gray-600 body-font bg-zinc-900">
    <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
      ...
      <nav class="md:ml-auto md:mr-auto flex flex-wrap items-center text-base justify-center">
        <a href="index.html" class="mr-5  text-orange-500">Home</a>
        <a href="services.html" class="mr-5 text-white hover:text-orange-500">Services</a>
        <a href="about us.html" class="mr-5 text-white hover:text-orange-500">About Us</a>
        <a href="contact us.html" class="mr-5 text-white hover:text-orange-500">Contact</a>
      </nav>
      <button
        class="inline-flex mr-3 items-center bg-gray-800 text-orange-500 border-0 py-1 px-3 focus:outline-none hover:text-white rounded text-base mt-4 md:mt-0"> <a href="login.html">Login</a> 
      ...
      <button
        class="inline-flex items-center bg-gray-800 text-orange-500 border-0 py-1 px-3 focus:outline-none hover:text-white rounded text-base mt-4 md:mt-0"> <a href="register.html">Register</a> 
        <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
          class="w-4 h-4 ml-1" viewBox="0 0 24 24">
          <path d="M5 12h14M12 5l7 7-7 7"></path>
        </svg>
