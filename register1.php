...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="div2">
            ...
            <!-- <p class="marg" style="margin-bottom: 0px;">Birthday</p>
            ...
            <p class="marg" style="margin-bottom: 0px;">Gender</p>
             <li style="margin-top: 0px;"><input type="radio" id="female" value="Female" name="gender"> <label for="female">Female</label>
