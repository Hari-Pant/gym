    ...
    <!-- <header class="text-gray-600 body-font bg-zinc-900">
        ...
        <span class="ml-3 text-orange-400 text-2xl">H-Fitness</span>
          ...
          <nav class="md:ml-auto md:mr-auto flex flex-wrap items-center text-base justify-center">
            ...
            <a href="contact us.php" class="mr-5 text-white text-orange-500 ">Contact</a>
          </nav>
          <button
    ...
    <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
        ...
        <div id="mega-menu" class="hidden justify-between items-center w-full text-sm md:flex md:w-auto md:order-1">
            <ul class="flex flex-col mt-4 font-semibold md:flex-row md:space-x-8 md:mt-0">
                ...
                <li>
                    <a href="contact us.php" class="block py-2 pr-4 pl-3 text-orange-400 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-orange-400 md:p-0 dark:text-gray-400 md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-blue-500 md:dark:hover:bg-transparent dark:border-gray-700" aria-current="page">Contact</a>
                </li>
            </ul>
        </div>
    </div>
          ...
          <div class="">
            <div class="flex flex-wrap  w-full bg-gray-100 py-32 px-10 relative ">
              ...
              <div class="text-center relative z-10 w-full">
                <h1 class="text-6xl text-gray-300 text-white font-bold title-font mb-2">CONTACT US
                </h1>
                
                <a href="index.html" class="text-white font-medium">Home  ></a> <a href="services.html" class="text-white font-medium">Services  ></a> <span class="text-orange-500 font-medium">CONTACT</span>
