...
<body>
    ...
    <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
        ...
        <div id="mega-menu" class="hidden justify-between items-center w-full text-sm md:flex md:w-auto md:order-1">
            <ul class="flex flex-col mt-4 font-semibold md:flex-row md:space-x-8 md:mt-0">
                ...
                <li>
                    <a href="about us.php" class="block py-2 pr-4 pl-3 text-orange-400 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-orange-400 md:p-0 dark:text-gray-400 md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-blue-500 md:dark:hover:bg-transparent dark:border-gray-700" aria-current="page">About Us</a>
                </li>
                <li>
          ...
          <div class="">
            <div class="flex flex-wrap  w-full bg-gray-100 py-32 px-10 relative ">
              ...
              <div class="text-center relative z-10 w-full">
                <h1 class="text-6xl text-gray-300 text-white font-bold title-font mb-2">ABOUT US
                </h1>
                
                <a href="index.html" class="text-white font-medium">Home  ></a> <span class="text-orange-500 font-medium">About Us</span>
    ...
    <div class="container  px-5 py-24 ">
      ...
      <div class="flex text-white flex-wrap -m-4">
        <div class="xl:w-1/3 md:w-1/2 p-4">
          <div class=" border-gray-200 p-6 rounded-lg ">
            <div id="icon"
              class="w-10 h-10 inline-flex hover:bg-orange-500 items-center justify-center rounded-full bg-indigo-100 text-indigo-500 mb-4">
              <img src="https://img.icons8.com/external-xnimrodx-lineal-color-xnimrodx/30/000000/external-gym-accommodation-and-hotel-xnimrodx-lineal-color-xnimrodx.png" />
            </div>
        ...
        <div class="xl:w-1/3 md:w-1/2 p-4">
          <div class=" border-gray-200 p-6 rounded-lg">
            <div
              class="w-10 h-10 inline-flex hover:bg-orange-500 items-center justify-center rounded-full bg-indigo-100 text-indigo-500 mb-4 ">
              <img src="https://img.icons8.com/ios/30/000000/healthy-eating.png"/>
            </div>
      ...
      <section class="text-gray-600 body-font bg-zinc-900 overflow-hidden">
        <div class="container px-5 py-24 mx-auto">
          <div class="lg:w-4/5 mx-auto flex flex-wrap">
            <img alt="ecommerce" class="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src="https://source.unsplash.com/400x400/?yoga">
            <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              <h2 class="text-sm title-font font-medium  text-orange-500 tracking-widest">ABOUT US</h2>
              <h1 class="text-white text-3xl title-font font-bold mb-1">WHAT WE HAVE DONE</h1>
              <div class="flex mb-4">
              ...
              <div>
                <div class="mb-6 ">
                    <p class="text-white mb-2">Body Building</p>
                    <div class="bg-black h-1 border-none mb-0 w-full">
                        <span class=" block relative h-full z-1 " data-percentage="80" style="background: rgb(255, 255, 255); width: 452.48px; transition: width 2s ease-in-out 0s;"></span>
                        
                        <div style="display:inline;">
                            <span style="font-size: 14px; padding: 0px; color: white; background: transparent; position: initial!important; float: right; margin-top: -40px;">80%</span>
                        </div>
                    </div>
                </div>

                <div class="mb-6 ">
                    <p class="text-white mb-2">Training</p>
                    <div class="bg-black h-1 border-none mb-0 w-full">
                        <span class=" block relative h-full z-1 " data-percentage="85" style="background: rgb(255, 255, 255); width: 480.76px; transition: width 2s ease-in-out 0s;"></span>
                        
                        <div style="display:inline;">
                            <span style="font-size: 14px; padding: 0px; color: white; background: transparent; position: initial!important; float: right; margin-top: -40px;">85%</span>
                        </div>
                    </div>
                </div>

                <div class="mb-6 ">
                    <p class="text-white mb-2">Fitness</p>
                    <div class="bg-black h-1 border-none mb-0 w-full">
                        <span class=" block relative h-full z-1 " data-percentage="75" style="background: rgb(255, 255, 255); width: 424.2px; transition: width 2s ease-in-out 0s;"></span>
                        
                        <div style="display:inline;">
                            <span style="font-size: 14px; padding: 0px; color: white; background: transparent; position: initial!important; float: right; margin-top: -40px;">75%</span>
                        </div>
                    </div>
                </div>
              </div>
        ...
        <div class="px-5 mx-28  mx-auto flex items-center md:flex-row flex-col">
          ...
          <div class="  px-5 py-10 ml-auto">
            <div class="lg:w-2/3 flex flex-col sm:flex-row sm:items-center items-start mx-auto">
              ...
              <button
                class="mt-3 p-3 px-5 text-white inline-flex mr-4 items-center border-2 border-orange-500"><a href="appointment.php">APPOINTMENT</a> </button>
            </div>
        ...
        <div class="">
          <div class="">
            <div class="flex flex-wrap  w-full bg-gray-100 py-32 px-10 relative ">
              ...
              <div class="text-center relative z-10 w-full">
                <h1 class="text-5xl text-gray-300 text-white font-medium title-font mb-2">REGISTRATION NOW TO GET MORE DEALS
                </h1>
                <p class="leading-relaxed text-gray-300 text-2xl font-medium">WHERE HEALTH, BEAUTY AND FITNESS MEET. </p>
                <button
                  class="mt-3 p-3 px-5 text-white inline-flex mt-10 items-center border-2 border-orange-500"><a href="appointment.php">APPOINTMENT</a> </button>
                <!-- <a class="mt-3 text-indigo-500 inline-flex items-center">Learn More -->
          ...
          <div class="flex flex-wrap -m-4">
            <div class="lg:w-1/3 lg:mb-0 mb-6 p-4">
              <div class="h-full text-center">
                <img alt="testimonial" class="w-36 h-36 mb-8 object-cover object-center rounded-full inline-block border-2 border-gray-200 bg-gray-100" src="https://source.unsplash.com/302x302/?gym girl">
                <p class="leading-relaxed text-white">Edison bulb retro cloud bread echo park, helvetica stumptown taiyaki taxidermy 90's cronut +1 kinfolk. Single-origin coffee ennui shaman taiyaki vape DIY tote bag drinking vinegar cronut adaptogen squid fanny pack vaporware.</p>
            ...
            <div class="lg:w-1/3 lg:mb-0 mb-6 p-4">
              <div class="h-full text-center">
                <img alt="testimonial" class="w-36 h-36 mb-8 object-cover object-center rounded-full inline-block border-2 border-gray-200 bg-gray-100" src="https://source.unsplash.com/300x300/?girl">
                <p class="leading-relaxed text-white">Edison bulb retro cloud bread echo park, helvetica stumptown taiyaki taxidermy 90's cronut +1 kinfolk. Single-origin coffee ennui shaman taiyaki vape DIY tote bag drinking vinegar cronut adaptogen squid fanny pack vaporware.</p>
                <span class="inline-block h-1 w-10 rounded bg-indigo-500 mt-6 mb-4"></span>
            ...
            <div class="lg:w-1/3 lg:mb-0 p-4">
              <div class="h-full text-center">
                <img alt="testimonial" class="w-36 h-36 mb-8 object-cover object-center rounded-full inline-block border-2 border-gray-200 bg-gray-100" src="https://source.unsplash.com/305x305/?girl">
                <p class="leading-relaxed text-white">Edison bulb retro cloud bread echo park, helvetica stumptown taiyaki taxidermy 90's cronut +1 kinfolk. Single-origin coffee ennui shaman taiyaki vape DIY tote bag drinking vinegar cronut adaptogen squid fanny pack vaporware.</p>
                <span class="inline-block h-1 w-10 rounded bg-indigo-500 mt-6 mb-4"></span>
                <h2 class="text-white font-medium title-font tracking-wider text-sm">HERLY LETHAM</h2>
